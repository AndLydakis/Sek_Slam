...
void odomCallback(const nav_msgs::Odometry::ConstPtr& msg)
{
    ...
    else if ((msg->twist.twist.linear.x < min_lin_x)&&(msg->twist.twist.linear.x >0.1))
    {
    ...
    else if((msg->twist.twist.angular.z < min_ang)&&(msg->twist.twist.angular.z >0.1))
    {

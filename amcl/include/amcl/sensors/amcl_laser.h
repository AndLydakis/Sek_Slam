...
class AMCLLaser : public AMCLSensor
{
  ...
  public: pf_vector_t GetLaserPose()
  {return this->laser_pose;}
  ...
  public: static std::vector<double> GetOptimalScan(AMCLLaserData *data, double x, double y, double z);
  private: laser_model_t model_type;
  //private: static double getSigmaHit(AMCLLaserData *data);
  ...
  private: pf_sample_t optimal_sample;
  //
